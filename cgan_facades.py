...
# Constants
PATH = 'facades/' # We will download the dataset here
BUFFER_SIZE = 400
BATCH_SIZE = 1
IMG_WIDTH = 256
IMG_HEIGHT = 256
...
# Corrected dataset URL for direct download using a known working source
...
# Corrected PATH to point to the actual directory containing 'train' and 'test' folders
PATH = os.path.join(os.path.dirname(path_to_zip) if os.path.isdir(path_to_zip) and not os.path.exists(os.path.join(path_to_zip, 'facades')) else path_to_zip, 'facades/')
